...
*btcrecover* includes experimental support for using one or more graphics cards or dedicated accelerator cards to increase search performance. This can offer on the order of *100x* better performance with Bitcoin Core or derived altcoin wallets when enabled and correctly tuned. 
...
*For reference, this command achieves around 6.5 KP/s on an NVidia 1660Ti*
